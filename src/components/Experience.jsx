...
We have a wide range of beverages!`,
  ...
  useFrame((_state, delta) => {
    ...
    if (lineMaterialRef.current) {
      lineMaterialRef.current.forEach((material) => {
      ...
      <>
        ...
        <group ref={cameraGroup}>
          ...
          <group ref={airplane} position={[0, 0, 0]}>
            <Float speed={2} floatIntensity={0.5} rotationIntensity={0.5}>
              <Airplane rotation-y={Math.PI / 2} scale={[0.3, 0.3, 0.3]} />
            </Float>
          </group>
        </group>
        ...
        <group position-y={-0.4}>
          <mesh>
            ...
            <meshStandardMaterial
              color={"white"}
              ref={(el) => (lineMaterialRef.current[0] = el)}
              opacity={0.6}
              transparent={true}
              envMapIntensity={2}
        ...
        <group position-y={-0.4}>
          <mesh>
            ...
            <meshStandardMaterial
              color={"white"}
              ref={(el) => (lineMaterialRef.current[1] = el)}
              opacity={0.6}
              transparent={true}
              envMapIntensity={2}
            />
        ...
        {/* CLOUDS */}
        {clouds.map((cloud, i) => (
          <Cloud sceneOpacity={sceneOpacity} key={i} {...cloud} />
        ))}
      </>
    ),
    []
